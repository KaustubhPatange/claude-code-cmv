...
Three features: auto-trim via Claude Code's `PreCompact` hook, batch branching with session status in the TUI, and a read-only live session viewer. v3.0.0 makes the viewer interactive.
